...
$authUrl = 'authentication.php?return_to=' . urlencode($currentPath);
?>
<html>
    <head>
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        ...
                        <div class="nav-right d-flex align-items-center">
                            ...
                            <div class="user-login">
                                <a href="<?php echo htmlspecialchars($authUrl, ENT_QUOTES, 'UTF-8'); ?>"><i class="fa-solid fa-circle-user text-dark fa-lg"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
